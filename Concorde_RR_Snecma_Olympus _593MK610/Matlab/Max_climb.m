% This code develops the calculation of the Olympus performance in maximum ascent at an altitude of 12000 meters following the transonic regime

clc;
close all;
%% DATI:
%_Condizioni di volo:
z= 12000; %altitudine [m]
M_0z= 1.2; %mach di volo
T_0z= 216.7; %temperatura a quota z [K]
P_0z= 19.330; %pressione a quota z [kPa]
rho_0z= 0.310; %densità a quota z [kg/m^3]
...
A_out=1; %area di efflusso dall'ugello
...
pm_ventd= 0; %portata massica in ingressso dalla ventilation door (pm_N=pm_C+pm_2+pm_ventd+pm_fb+pm_fab)
...
% pm_1= pm_in/(BPR+1); portata principale calcolata successivamente
% pm_2= pm_in-pm_1; portata secondaria calcolata successivamente
...
Cs= T/(P_4totAt10^3) %coefficente di spinta
