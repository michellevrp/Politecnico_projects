%This code develops the Olympus performance calculation in ascent to zero altitude with attention to noise reduction
...
%_Condizioni di volo:
z= 0; %altitudine
v_0z= 128.5; %velocità di volo [m/s]
T_0z= 288.16; %temperatura a quota z[K]
P_0z= 101.325; %pressione a quota z
rho_0z= 1.225; %densità a quota z
...
A_out=0.62; %area di efflusso dall'ugello
